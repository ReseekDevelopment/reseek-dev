...
var mouseMultiplier = 1.0; // You can set the value to whatever you need

// Use mouseMultiplier in your smooth scrolling logic
function smoothScroll(event) {
  var delta = event.deltaY || event.detail || event.wheelDelta;

  // Adjust the scroll speed using mouseMultiplier
  var scrollAmount = delta * mouseMultiplier;

  // Perform smooth scrolling here
  // ...
}

// Add an event listener to call smoothScroll when a scroll event occurs
